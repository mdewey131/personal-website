...
Those of you with some background in hypothesis testing already will no doubt notice that we already use alpha as a symbol for the significance level. This is not an accident: **the significance level of a test is the probability that such a test makes a type I error**. 
