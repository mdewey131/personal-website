...
coverCaption: "A visualization presented to users in-app of the score share across 1000 simulated games, sorted by team A's score differential with B. Here, team A is predicted to win around 30% of the time."
coverMeta: out
...
In this article, I walk through my reasoning for making a Markov chain model and how I use it to
estimate win probabilities through simulation.
<!--more-->
