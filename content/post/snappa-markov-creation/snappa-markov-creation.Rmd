...
---
<!--- Introductory Blurb that will serve as the lead in on the home page -->
...
identially distributed random variables. Once data is organized into a time series, 
...
be in the next moment. The Markov chain model in this data set specifically models
